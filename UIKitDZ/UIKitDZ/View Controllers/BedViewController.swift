...
class BedViewController: UIViewController {
    ...
    private let imageArray = [UIImage(named: "кровать1"),
                      UIImage(named: "кровать2"),
                      UIImage(named: "кровать3")]
    ...
    private let nameHouseArray = ["Neo", "Amal Grey", "Casablanca"]
    ...
    @objc private func selectedValue(target: UISegmentedControl) {
            ...
            descriptionTextView.text = descriptText.descriptionBedArray[segmentIndex]
    }
